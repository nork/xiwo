...
public class CarModify extends BaseCommand {
	private static final String CMD = "carModify.do";
	...
	protected List<NameValuePair> getParameters() {
		...
		nvps.add(new BasicNameValuePair(PARAM_CUSTOM_ID, Long
				.toString(customerId)));
	...
	protected BaseResponse parseResponse(String content) {
		// TODO Auto-generated method stub
		Response carModify = new Response();

		try {
			JSONObject jsonObj = new JSONObject(content);
			carModify.responseType = jsonObj.getString(JSON_RESPONSE_TYPE);
			carModify.errorMessage = jsonObj.getString(JSON_ERROR_MESSAGE);
			carModify.okey = true;

			carModify.carId = jsonObj.getString(JSON_CAR_ID);
