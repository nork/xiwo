...
public class AppLog {
	private static Boolean MYLOG_SWITCH = false; // 日志文件总开�?
	private static Boolean MYLOG_WRITE_TO_FILE = false;// 日志写入文件�?��
	...
	private static String MYLOGFILEName = "AppLog.txt";// 本类输出的日志文件名�?
